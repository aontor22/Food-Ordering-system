...
ALTER TABLE "Order" ADD COLUMN "pointsAwardedAt" DATETIME;
ALTER TABLE "Order" ADD COLUMN "pointsRestoredAt" DATETIME;
...
INSERT OR IGNORE INTO "LoyaltySetting" ("id", "enabled", "pointsPerOrder", "minimumRedeemPoints", "pointValueCents", "updatedAt")
